...
const requireCheck = [ETH_NODE, GOERLI_NODE, BSC_NODE, BSC_TESTNET_NODE, FANTOM_TESTNET_NODE]
...
export const v3SubgraphClients = {
  ...
  [ChainId.FANTOM_TESTNET]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.FANTOM_TESTNET], { fetch }),
}
