        ...
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Create a referral gauge')}
            </Heading>
            <Text color="textSubtle" small mb="16px">
              {t(
                'Create a referral gauge and start referring users to businesses on CanCan or eCollectible. You get a vote each time a user you referred buys from a business.',
              )}
            </Text>
            {/* {renderAccountStatus()} */}
          </CardBody>
          ...
          <CardBody>
            ...
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t(
                  'You get assigned rewards each week based on the amount of votes you get from the CanCan or eCollectible marketplace.',
                )}
              </Text>
            </Box>
          </CardBody>
