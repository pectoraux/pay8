...
const totalCost = BIG_ZERO // MINT_COST.add(REGISTER_COST)
const allowance = BIG_ZERO // totalCost.mul(ALLOWANCE_MULTIPLIER)
...
const ProfileCreationProvider: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const actions: ContextType['actions'] = useMemo(
    () => ({
      ...
      setSelectedNft: (tokenId: string, collectionAddress: any) =>
