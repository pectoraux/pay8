        ...
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Deploy a Bill contract')}
            </Heading>
            <Text color="textSubtle" small mb="16px">
              {t('This will enable you to start receiving applications!')}
            </Text>
          ...
          <CardBody>
            ...
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t(
                  'Select the Update Application Link option from the Control Panel and input a link to a google form or any form users can fill to apply for account with your Bill contract.',
                )}
              </Text>
            </Box>
          </CardBody>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('You can then start creating accounts for your users.')} <br />
            </Text>
          </CardBody>
        )
      default:
