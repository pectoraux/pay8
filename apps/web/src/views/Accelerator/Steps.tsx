        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('Create a video with the elevator pitch of your business to convince users to vote for you!')}
            </Text>
            {/* {renderAccountStatus()} */}
          </CardBody>
        )
          ...
          <CardBody>
            ...
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t('You get assigned rewards each week based on the number of vote shares you get.')}
              </Text>
            </Box>
          </CardBody>
        )
