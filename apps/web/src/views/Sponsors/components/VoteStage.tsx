      ...
      <GreyedOutContainer>
        <StyledItemRow>
          ...
          <ButtonMenu
            scale="xs"
            variant="subtle"
            activeIndex={state.like ? 1 : 0}
            onItemClick={handleRawValueChange('like')}
          >
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          <Text small color="textSubtle">
            {t(
              'The will vote either positively or negatively for the sponsor. Please read the documentation for more information.',
            )}
          </Text>
        </Box>
      </Grid>
