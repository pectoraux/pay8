      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t(
                "You’ll need a bounty to cover your world contract in order to start minting NFTs. Once you've created your bounty, you'll need to attach it to your world!",
              )}
            </Text>
