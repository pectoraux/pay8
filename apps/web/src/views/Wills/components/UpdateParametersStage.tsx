...
const SetPriceStage: React.FC<any> = ({ state, handleChange, continueToNextStage }) => {
  ...
  const TooltipComponent2 = () => (
    <Text>
      {t("This sets the maximum percentage of any fungible token's balance withdrawable between each update period.")}
    </Text>
  )
  const TooltipComponent3 = () => (
    <Text>{t('This sets the maximum number of non fungible tokens withdrawable between each update period.')}</Text>
  )
  ...
  return (
    <>
      ...
      <GreyedOutContainer>
        <Flex ref={targetRef2}>
          <Text fontSize="12px" color="secondary" textTransform="uppercase" bold>
            {t('Maximum Fungible Token Withdrawable Now')}
          </Text>
        ...
        <Input
          ...
          placeholder={t('input max withdrawable now')}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
        <Flex ref={targetRef3}>
          <Text fontSize="12px" color="secondary" textTransform="uppercase" bold>
            {t('Maximum NFT Withdrawable Now')}
          </Text>
        ...
        <Input
          ...
          placeholder={t('input max nft withdrawable now')}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
        <Flex ref={targetRef4}>
          <Text fontSize="12px" color="secondary" textTransform="uppercase" bold>
            {t('Will Withdrawal Period (minutes)')}
          </Text>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          <Text small color="textSubtle">
            {t("This will update parameters of the Will. Please read each parameter's description for more details.")}
          </Text>
        </Box>
      </Grid>
      <Divider />
