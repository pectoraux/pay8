      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          <Text small color="textSubtle">
            {t(
              'This will update the location information of your Profile to enable users to find it more easily. Location tags can be helpful for instance for Profiles targeting users in specific locations to be discovered faster by those users. You can also add more custom tags related to the purpose of your Profile.',
            )}
          </Text>
        </Box>
      </Grid>
