    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('Lock tokens in all the valuepools you are willing to participate in')}
            </Text>
            {/* {renderAccountStatus()} */}
          </CardBody>
        )
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t("Participate in the Valuepool's votes")}
            </Heading>
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t(
                  'Become an active member of the Valuepools you join and participate in their activities to grow the communities.',
                )}
              </Text>
            </Box>
          </CardBody>
