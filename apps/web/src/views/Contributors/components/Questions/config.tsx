...
const config = [
  {
    title: <Trans>What is a contributor gauge ?</Trans>,
    description: [
      <Trans>
  ...
  {
    title: <Trans>How do you vote for a contributor ?</Trans>,
    description: [
  ...
  {
    title: <Trans>What happens if a contributor lies or commits fraud ?</Trans>,
    description: [
