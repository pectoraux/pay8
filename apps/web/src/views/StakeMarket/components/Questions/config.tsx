...
const config = [
  {
    title: <Trans>What is the stake market ?</Trans>,
    description: [
      <Trans>
  ...
  {
    title: <Trans>What problem is the stake market solving?</Trans>,
    description: [
  ...
  {
    title: <Trans>How much does it cost to create/apply to a stake ?</Trans>,
    description: [
  ...
  {
    title: <Trans>Is the stake market a Ponzi Scheme?</Trans>,
    description: [<Trans>The CAKE from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>What happens if my stake mate is a fraud ?</Trans>,
    description: [
