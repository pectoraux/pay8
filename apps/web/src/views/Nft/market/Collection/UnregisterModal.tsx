...
const RegisterModal: React.FC<any> = ({ collectionId, userBountyId, userCollectionId, onDismiss }) => {
  ...
  }, [state, t, collectionId, toastSuccess, callWithGasPrice, marketHelper3Contract, fetchWithCatchTxError])

  return (
    <Modal title={t('Unregister from Channel')} onDismiss={onDismiss}>
      <GreyedOutContainer>
