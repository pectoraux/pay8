    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        <Input
          ...
          placeholder={t("input item's price")}
          onChange={handleChange}
        />
      </GreyedOutContainer>
      <GreyedOutContainer>
      ...
      <GreyedOutContainer>
        <StyledItemRow>
          ...
          <ButtonMenu
            scale="xs"
            variant="subtle"
            activeIndex={state.isPaywall}
            onItemClick={handleRawValueChange('isPaywall')}
          >
