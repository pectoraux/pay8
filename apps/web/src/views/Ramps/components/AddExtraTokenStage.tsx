...
const AddExtraTokenStage: React.FC<any> = ({ state, handleChange, continueToNextStage }) => {
    ...
    <>
      <GreyedOutContainer>
        ...
        <Input
          ...
          name="token"
          value={state.token}
          placeholder={t('input extra token address')}
...
export default AddExtraTokenStage
