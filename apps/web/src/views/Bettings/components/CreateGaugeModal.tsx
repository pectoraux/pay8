...
const CreateGaugeModal: React.FC<any> = ({ variant = 'user', pool, currAccount, currency, refetch, onDismiss }) => {
  ...
  const [state, setState] = useState<any>(() => ({
    ...
    periodReceivable: parseInt(currAccount?.bracketDuration ?? '0') / 60,
