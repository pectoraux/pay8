        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need this to start creating accounts receivable and payables!')}
            </Text>
          ...
          <CardBody>
            ...
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t(
                  'Select the Update Application Link option from the Control Panel and input a link to a google form or any form users can fill to apply for account with your ARP contract.',
                )}
              </Text>
            </Box>
          </CardBody>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('You can then start creating accounts for users.')} <br />
            </Text>
          </CardBody>
        )
      default:
