    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need this to start selling lottery tickets to your lottery.')}
            </Text>
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Set Lottery Results')}
            </Heading>
            <Box>
              <Text mb="4px" color="textSubtle" small>
                {t('At the end of your lottery, you can have a trusted auditor to set the results of your lottery.')}
              </Text>
            </Box>
          </CardBody>
        )
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('Depending on their lottery numbers, users can claim rewards from the lottery.')} <br />
            </Text>
          </CardBody>
        )
      default:
