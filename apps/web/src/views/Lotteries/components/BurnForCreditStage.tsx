...
const BurnForCreditStage: React.FC<SetPriceStageProps> = ({
  ...
  const TooltipComponent = () => (
    <Text>
      {t(
        'This sets the position/index of the burn for credit discount for which you would like to claim discounts. The index is available in the parameters section of this lottery.',
      )}
    </Text>
  )
  const TooltipComponent2 = () => (
    <Text>
      {t(
        'This is necessary for the lottery to understand how to transfer your token. Pick No if it is not an NFT and Yes otherwise.',
      )}
    </Text>
  )
