...
const config = [
  ...
  {
    title: <Trans>What problem are Lotteries solving?</Trans>,
    description: [
  ...
  {
    title: <Trans>How much does it cost to operate a Lottery ?</Trans>,
    description: [
  ...
  {
    title: <Trans>Are Lotteries a Ponzi Scheme?</Trans>,
