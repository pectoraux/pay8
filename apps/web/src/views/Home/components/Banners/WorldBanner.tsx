...
export const WorldBanner = () => {
  ...
  const title = t('Build the metaverse with World contracts')
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          {isDesktop && (
            <Text color="#FFE437" fontSize={24} fontWeight={700} mb="8px">
              {t('World contracts incentivize coders to build a virtual replica of the world')}
            </Text>
          )}
          <Flex>
            <NextLinkFromReactRouter target="_blank" to="/worlds">
              <StyledButtonLeft scale={['xs', 'sm', 'md']}>
                <Text bold fontSize={['12px', '16px']} mr="4px">
                  {t('Create a World contract')}
                </Text>
        ...
        <RightWrapper>
          <BGWrapper>
            <Image src={'/images/cancan/356.jpg'} alt="Background" width={338} height={176} unoptimized />
          </BGWrapper>
        </RightWrapper>
      </S.Inner>
    </S.Wrapper>
