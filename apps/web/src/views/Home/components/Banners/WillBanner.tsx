  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          {isDesktop && (
            <Text color="#FFE437" fontSize={24} fontWeight={700} mb="8px">
              {t('Setup a contract to transfer assets to your heirs after your death')}
            </Text>
          )}
          <Flex>
        ...
        <RightWrapper>
          <BGWrapper>
            <Image src={'/images/cancan/352.jpg'} alt="Background" width={338} height={176} unoptimized />
          </BGWrapper>
          {/* {isMobile ? (
