...
export const SponsorBanner = () => {
  ...
  const title = t('Sponsor contracts let you program sponsorship terms')
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          {isDesktop && (
            <Text color="#FFE437" fontSize={24} fontWeight={700} mb="8px">
              {t('You can receive/send sponsorship requests and program all its payments')}
            </Text>
          )}
          <Flex>
            <NextLinkFromReactRouter target="_blank" to="/sponsors">
              <StyledButtonLeft scale={['xs', 'sm', 'md']}>
                <Text bold fontSize={['12px', '16px']} mr="4px">
                  {t('Create an Sponsorship contract')}
                </Text>
        ...
        <RightWrapper>
          <BGWrapper>
            <Image src={'/images/cancan/332.jpg'} alt="Background" width={338} height={176} unoptimized />
          </BGWrapper>
          {/* {isMobile ? (
