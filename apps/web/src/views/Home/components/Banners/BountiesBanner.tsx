...
`
export const BountiesBanner = () => {
  const { t } = useTranslation()
  const { isMobile, isDesktop } = useMatchBreakpoints()

  const title = t('Create a bounty to prove trustworthiness')
  ...
  return (
    ...
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          {isDesktop && (
            <Text color="#FFE437" fontSize={24} fontWeight={700} mb="8px">
              {t('They are collaterals users stake to guarantee they will obey specific terms')}
            </Text>
          )}
          <Flex>
            <NextLinkFromReactRouter target="_blank" to="/trustbounties">
        ...
        <RightWrapper>
          <BGWrapper>
            <Image src={'/images/cancan/323.jpg'} alt="Background" width={338} height={176} unoptimized />
          </BGWrapper>
          {isMobile ? (
