        ...
        <S.LeftWrapper>
          ...
          {isDesktop && (
            <Text color="#FFE437" fontSize={24} fontWeight={700} mb="8px">
              {t('Just like credit cards, paycards enable you to checkout with just a password')}
            </Text>
          )}
          <Flex>
            <NextLinkFromReactRouter target="_blank" to="/paycards">
