        ...
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Deploy an Audit contract')}
            </Heading>
            <Text color="textSubtle" small mb="16px">
              {t('This will enable you to start receiving audit applications!')}
            </Text>
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('You can then start creating accounts for users you are auditing.')} <br />
            </Text>
          </CardBody>
        )
      default:
