...
export const PAYSWAP_ONRAMP_TOKENS = 'https://tokens.payswap.org/payswap-onramp.json'
...
export const FANTOM_TESTNET_URLS = [PAYSWAP_ONRAMP_TOKENS]
...
export const OFFICIAL_LISTS = [PANCAKE_EXTENDED, PANCAKE_ETH_DEFAULT, PAYSWAP_ONRAMP_TOKENS]
