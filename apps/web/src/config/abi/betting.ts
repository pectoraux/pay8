export const bettingABI = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: 'uint256',
        name: '_bettingTicketId',
        type: 'uint256',
      },
    ],
    name: '_checkIdentityProof',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'enum BettingStatus',
        name: '',
        type: 'uint8',
      },
    ],
