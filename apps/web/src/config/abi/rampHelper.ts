export const rampHelperABI = [
  ...
  },
  {
    ...
    name: 'updateOracleUpdateAllowance',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
